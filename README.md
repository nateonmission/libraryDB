...
| GET    |api/publishers/{publisherID}/authors| returns a a publisher's authors| None          |
| PUT    |api/authors/{authorID}              | updates specific author        | Author info   |
| PUT    |api/authors/publishers/{authorID}   | updates a publisher's authors  | Publisher ids |
